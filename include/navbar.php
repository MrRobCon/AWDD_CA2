...
<nav class="navbar navbar-expand-md navbar-light sticky-top">
  ...
  <div class="collapse navbar-collapse" id="div-navbar-items">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item">
        <a class="nav-link" href="<?= APP_URL ?>/views/customer/home.php">Home <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
    ...
    <a class="navbar-brand" href="<?= APP_URL ?>/views/customer/home.php"><img src="assets/img/Logo V1.png" width="100" height="50"></a>
